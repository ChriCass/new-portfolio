...
const cards = [
  {
    id: '01', href: 'https://invigoratedwater.com', year: '2025',
    title: 'Invigorated Water', badge: 'PDP · CART',
    ...
    tags: ['Liquid', 'OS 2.0'], metric: '+32% LCP', featured: false,
    thumb: (
  ...
  {
    id: '02', href: 'https://www.trysuji.com', year: '2025',
    title: 'Try Suji', badge: 'QUIZ · A/B',
    ...
    tags: ['Checkout Ext.', 'Functions'], metric: '+18% AOV', featured: false,
    thumb: (
  ...
  {
    id: '03', href: 'https://getsowell.com', year: '2024',
    title: 'Get Sowell', badge: 'SUBSCRIPTIONS',
    ...
    tags: ['Storefront API', 'GraphQL'], metric: '+24% sub attach', featured: false,
    thumb: (
  ...
  {
    id: '04', href: 'https://berkeleylife.com', year: '2024',
    title: 'Berkeley Life', badge: 'METAOBJECTS',
    ...
    tags: ['Metaobjects', 'Admin API'], metric: '−42% CLS', featured: false,
    thumb: (
  ...
  {
    id: '05', href: 'https://tanoskincare.com', year: '2025',
    title: 'Tano Skincare', badge: 'BEAUTY / DTC',
    desc: 'Clean skincare line. Built a routine builder with progressive disclosure and a custom shade-by-tone component powered by Shopify Functions for stock-aware bundling. Locked +27% CVR on mobile via 6-week split test.',
    tags: ['Shopify Functions', 'Bundling', 'Liquid'], metric: '+27% CVR', featured: true,
    thumb: (
...
/* card normal (mobile swiper + desktop 2-col grid) */
const CardInner = ({ card }: { card: Card }) => (
  <a href={card.href} target="_blank" rel="noopener"
    className="no-underline text-inherit block h-full p-7 border border-white/8 rounded-[14px] bg-white/1.5 hover:border-white/18 hover:bg-white/3 transition-colors">
...
/* card featured — full width, thumb left / content right (desktop only) */
