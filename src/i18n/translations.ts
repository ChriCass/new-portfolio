...
const en: TranslationDict = {
  ...
  'selectedWork.subtitle.frontend':
    '5 frontends shipped to production for DTC brands',
  'selectedWork.subtitle.shopify':
    '5 of 80+ DTC brands shipped to production',
...
const es: TranslationDict = {
  ...
  'selectedWork.subtitle.frontend':
    '5 frontends lanzados a producción para marcas DTC',
  'selectedWork.subtitle.shopify':
    '5 de 80+ marcas DTC lanzadas a producción',
