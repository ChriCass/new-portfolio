...
const en: TranslationDict = {
  ...
  'hero.paragraph.frontend':
    'Frontend engineer with 3 years across React, Vue, TypeScript and modern CSS. Currently at Step Labs in London — design-system-driven UI, accessible components, motion, and Core Web Vitals work. Shipped UI across 80+ brands influencing £35M+ revenue.',
  'hero.paragraph.shopify':
    'Full-stack engineer with 3 years across Liquid, Laravel and Vue. Currently at Step Labs in London — Shopify Plus, OS 2.0, Theme App Extensions, Checkout Extensibility. Influenced £35M+ revenue across 80+ DTC brands through CRO, A/B testing and Core Web Vitals work.',
  ...
  'exp.desc.frontend.1':
    'Accounting firm. Led the frontend of a multi-tenant accounting platform serving 5+ companies — reactive UI with Livewire + Wire UI, Bootstrap / SCSS design system.',
  ...
  'exp.bullet.shopify.0.1': 'Weekly A/B tests on PDP, cart, checkout — +30% uplift guaranteed / 90d.',
...
const es: TranslationDict = {
  ...
  'hero.paragraph.frontend':
    'Ingeniero Frontend con 3 años de experiencia en React, Vue, TypeScript y CSS moderno. Actualmente en Step Labs en Londres — UI basada en design systems, componentes accesibles, motion y Core Web Vitals. UI desplegada en más de 80 marcas influyendo £35M+ en ingresos.',
  'hero.paragraph.shopify':
    'Ingeniero full-stack con 3 años de experiencia en Liquid, Laravel y Vue. Actualmente en Step Labs en Londres — Shopify Plus, OS 2.0, Theme App Extensions, Checkout Extensibility. Influí £35M+ en ingresos en más de 80 marcas DTC mediante CRO, A/B testing y Core Web Vitals.',
  ...
  'exp.company.frontend.1': 'RPU & Asociados',
  'exp.desc.frontend.1':
    'Firma contable. Lideré el frontend de una plataforma contable multi-tenant para más de 5 empresas — UI reactiva con Livewire + Wire UI, design system Bootstrap / SCSS.',
  ...
  'exp.bullet.shopify.0.1': 'A/B tests semanales en PDP, carrito, checkout — +30% de mejora garantizada / 90d.',
